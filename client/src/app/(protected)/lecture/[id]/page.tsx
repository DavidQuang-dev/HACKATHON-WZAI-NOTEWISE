            ...
            <Card key={i} className="bg-white">
              <CardContent className="p-4">
                <h3 className="font-semibold text-gray-900 mb-3">
                  Lecture {i}: Introduction to Psychology
                </h3>
                <div className="space-y-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-gray-600">
                      ...
                      Advanced Calculus. It includes problems on
                      differentiation, integration, and applications of
                      derivatives. Please ensure you have reviewed the lecture
                      notes and practice problems before attempting this quiz.
                      Good luck!
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-4">
