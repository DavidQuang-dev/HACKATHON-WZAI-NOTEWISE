...
import { FileText, MessageSquare, HelpCircle, BookOpen, GraduationCap, Search, Settings } from "lucide-react"
    ...
    switch (activeTab) {
        ...
        return (
          <div className="space-y-6">
            <div className="prose max-w-none">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Key Points Summary</h3>
            </div>
              ...
              <div className="space-y-4">
                {summarizedNotes.map((note, index) => (
                  <div key={index} className="flex items-start gap-4">
                    ...
                    <p className="text-gray-700 leading-relaxed text-base">{note}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      case "transcript":
        return (
          <div className="space-y-6">
            <div className="prose max-w-none">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Complete Lecture Transcript</h3>
            </div>
            <div className="bg-gray-50 p-6 rounded-xl">
              <p className="text-gray-700 leading-relaxed text-base">{fullTranscript}</p>
            </div>
          </div>
        )
      case "questions":
        return (
          <div className="space-y-6">
            <div className="prose max-w-none">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Practice Quiz</h3>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl border border-blue-100">
              <p className="text-gray-700 mb-6 leading-relaxed">
                This quiz covers the key concepts from Lecture 1 on Introduction to Psychology. It includes questions on
                fundamental principles, research methods, and major perspectives. Please ensure you have reviewed the
                lecture notes before attempting this quiz. Good luck!
              </p>
              <div className="bg-white p-4 rounded-lg shadow-sm">
                <h4 className="font-semibold text-gray-900 mb-4">Quiz Details</h4>
          ...
          <div className="space-y-6">
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600">
                Ask questions about this lecture and get instant answers from our AI tutor.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              />
              <Button className="bg-blue-600 hover:bg-blue-700 h-12 px-6">Send</Button>
            </div>
          </div>
        )
      default:
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        <div className="w-80 bg-white/60 backdrop-blur-sm border-r border-gray-200/50 min-h-screen">
          <div className="sticky top-20 p-6">
            <div>
              <h2 className="text-lg font-bold text-gray-900 mb-4">Lecture 1: Introduction to Psychology</h2>
              <Card className="border-0 shadow-lg shadow-gray-200/50 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100">
          ...
          <div className="max-w-4xl">
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-2">
                <Badge className="bg-blue-100 text-blue-700 border-0">Psychology</Badge>
                <Badge className="bg-green-100 text-green-700 border-0">Lecture 1</Badge>
              </div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">
                {sidebarItems.find((item) => item.id === activeTab)?.title}
              </h1>
              <p className="text-gray-600">Introduction to Psychology • 45 minutes • Dr. Smith</p>
            </div>
