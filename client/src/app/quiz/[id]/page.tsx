...
import { Lightbulb, Check, X, ArrowLeft, BookOpen, GraduationCap } from "lucide-react"
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border-0 shadow-xl shadow-gray-200/50 bg-white/80 backdrop-blur-sm">
              <CardHeader className="text-center pb-8">
                ...
                <p className="text-gray-600 mt-2">Lecture 1: Introduction to Psychology</p>
              </CardHeader>
              <CardContent className="text-center space-y-8 pb-8">
                    ...
                    {Array.from({ length: totalQuestions }, (_, i) => (
                      ...
                      >
                        <span className="text-sm font-medium">
                          Question {i + 1}: What is the main function of the cell membrane?
                        </span>
                ...
                <div className="flex gap-4 justify-center">
                  <Button variant="outline" className="h-12 px-8 bg-transparent border-gray-200 hover:bg-gray-50">
                    Retake Quiz
                  </Button>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <main className="p-8">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Lecture 1: Introduction to Psychology</h1>
            <p className="text-gray-600 text-lg">Multiple Choice Questions</p>
            <p className="text-sm text-gray-500 mt-1">Choose the best answer for each question.</p>
          </div>

          <div className="space-y-4">
            <Progress value={((currentQuestion + 1) / questions.length) * 100} className="w-full h-3 bg-gray-200" />
              ...
              {showHint && (
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-6">
                  <div className="flex items-center gap-3 text-yellow-800 mb-3">
                    ...
                    <span className="font-semibold">Hint for question: What is the main topic of this chapter?</span>
                  </div>
                  <p className="text-yellow-700 font-medium">{questions[currentQuestion].hint}</p>
                </div>
              )}
